...
- [基盤3点セット 全体設計方針](design-unilab-foundation-overview.md) — AssetDelivery / IAP / Popup v2 の疎結合方針と asmdef 構成
- [UniLab.AssetDelivery](design-unilab-asset-delivery.md) — Addressable 配信基盤（差分チェック・事前ダウンロード）
