...
<img src="Documentation~/Images/asset_reference_finder.png" width="529">
...
<img src="Documentation~/Images/missing_checker.png" width="602">
...
<img src="Documentation~/Images/script_usage_checker.png" width="423">
...
<img src="Documentation~/Images/favorite_assets.png" width="483">
...
<img src="Documentation~/Images/hierarchy_favorite.png" width="607">

#### 使い方

1. Hierarchy ウィンドウから登録したい GameObject を、Hierarchy Favorite ウィンドウの「Hierarchy の GameObject をここにドラッグ」エリアにドラッグ&ドロップする
2. 登録されたエントリはシーン別にグルーピングされ、GameObject のパス（例: `GameObject (1)/GameObject (1)/Test`）とともに表示される
3. 各エントリにはメモ欄があり、自由にコメントを付けられる
4. エントリをクリックすると対象の GameObject を Hierarchy 上で選択・ハイライトする

#### ポイント

- ドラッグ&ドロップで直感的に登録できる（右クリックメニューからも登録可能）
- GlobalObjectId でシリアライズされるため、シーンの保存/リロードに耐える
- 削除済み・未ロードの GameObject は "Missing" 表示になる（スクリーンショット内の `SampleScene` エントリ参照）
